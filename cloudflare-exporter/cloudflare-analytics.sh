...
InfluxDBURL="${INFLUXDB_URL:="http://10.101.0.21"}" #Your InfluxDB Server, http://FQDN or https://FQDN if using SSL
...
InfluxDBPassword="${INFLUXDB_PASSWORD:="telegraf"}" #Password for Database
